...
public class FemmeController implements Initializable {
    @FXML
    ...
    private void loadProducts() {
        ...
        List<Product> products = dbConnection.getProductsBySubCategory_femme(3); // You can change the sub-category ID here
    ...
    public void switchtoaccessoire(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("accessoire.fxml"));
        Stage newStage = new Stage();
        Scene newScene = new Scene(root);
        newStage.setScene(newScene);
        newStage.show();
