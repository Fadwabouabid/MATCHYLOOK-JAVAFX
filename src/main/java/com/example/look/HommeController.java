...
public class HommeController implements Initializable {
    @FXML
    ...
    private void loadProducts() {
        ...
        List<Product> products = dbConnection.getProductsBySubCategory(3); // You can change the sub-category ID here
